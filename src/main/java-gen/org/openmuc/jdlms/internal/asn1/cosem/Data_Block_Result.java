...
public class Data_Block_Result implements AxdrType {
    ...
    public Data_Block_Result() {
    }

    public Data_Block_Result(byte[] code) {
        this.code = code;
    }

    public Data_Block_Result(AxdrBoolean last_block, Unsigned16 block_number, AxdrOctetString raw_data) {
