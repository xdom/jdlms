...
public class ASNParser extends antlr.LLkParser implements ASNTokenTypes {
        ...
        try { // for error handling
            {
                if ((LA(1) == NUMBER)) {
                    ...
                    if (synPredMatched88) {
                        ...
                        if (((LA(1) == UPPER || LA(1) == LOWER) && (_tokenSet_9.member(LA(2)))
                                && (_tokenSet_5.member(LA(3))))) {
                            int _m94 = mark();
    ...
    public final List<String> symbol_list() throws RecognitionException, TokenStreamException {
        List<String> symlist;
                ...
                match(FROM_KW);
                {
                    ...
                    }
                    {
                        if ((LA(1) == L_BRACE)) {
                            ...
                            if (((LA(1) == UPPER || LA(1) == LOWER) && (_tokenSet_17.member(LA(2)))
    ...
    public final AsnValue value() throws RecognitionException, TokenStreamException {
        ...
        try { // for error handling
            ...
            default:
                ...
                if (((LA(1) == UPPER || LA(1) == LOWER) && (_tokenSet_23.member(LA(2)))
                    ...
                    if ((LA(1) == RESULT_KW) && (_tokenSet_40.member(LA(2))) && (_tokenSet_30.member(LA(3)))) {
                        ...
                        }
                        {
                            ...
                            if (synPredMatched275) {
                                ...
                                if (((_tokenSet_11.member(LA(1))) && (_tokenSet_38.member(LA(2)))
                                        && (_tokenSet_39.member(LA(3))))) {
                                    int _m278 = mark();
        ...
        try { // for error handling
            {
                match(EXCLAMATION);
                {
                    ...
                    if (synPredMatched355) {
                        ...
                        if (((LA(1) == UPPER || LA(1) == LOWER) && (LA(2) == DOT || LA(2) == R_PAREN)
                                && (_tokenSet_55.member(LA(3))))) {
                            int _m358 = mark();
    ...
    public static final String[] _tokenNames = { "<0>", "EOF", "<2>", "NULL_TREE_LOOKAHEAD", "\"ABSENT\"",
            ...
            "\"INTERSECTION\"", "\"ISO646String\"", "\"LINKED\"", "\"MAX\"", "\"MINUSINFINITY\"", "\"MIN\"", "\"NULL\"",
            "\"NumericString\"", "\"ObjectDescriptor\"", "\"OBJECT\"", "\"OCTET\"", "\"OPERATION\"", "\"OF\"",
            "\"OID\"", "\"OPTIONAL\"", "\"PARAMETER\"", "\"PDV\"", "\"PLUSINFINITY\"", "\"PRESENT\"",
            "\"PrintableString\"", "\"PRIVATE\"", "\"REAL\"", "\"RELATIVE\"", "\"RESULT\"", "\"SEQUENCE\"", "\"SET\"",
            "\"SIZE\"", "\"STRING\"", "\"TAGS\"", "\"TeletexString\"", "\"TRUE\"", "\"TYPE-IDENTIFIER\"", "\"UNION\"",
            "\"UNIQUE\"", "\"UNIVERSAL\"", "\"UniversalString\"", "\"UTCTime\"", "\"UTF8String\"", "\"VideotexString\"",
            "\"VisibleString\"", "\"WITH\"", "ASSIGN_OP", "BAR", "COLON", "COMMA", "COMMENT", "DOT", "DOTDOT",
            "ELLIPSIS", "EXCLAMATION", "INTERSECTION", "LESS", "L_BRACE", "L_BRACKET", "L_PAREN", "MINUS", "PLUS",
            "R_BRACE", "R_BRACKET", "R_PAREN", "SEMI", "SINGLE_QUOTE", "CHARB", "CHARH", "WS", "SL_COMMENT", "NUMBER",
            "UPPER", "LOWER", "BDIG", "HDIG", "B_OR_H_STRING", "B_STRING", "H_STRING", "C_STRING", "\"BIND\"",
            "\"UNBIND\"", "\"APPLICATION-SERVICE-ELEMENT\"", "\"APPLICATION-CONTEXT\"", "\"EXTENSION\"",
            "\"EXTENSIONS\"", "\"EXTENSION-ATTRIBUTE\"", "\"TOKEN\"", "\"TOKEN-DATA\"", "\"SECURITY-CATEGORY\"",
            "\"PORT\"", "\"REFINE\"", "\"ABSTRACT-BIND\"", "\"ABSTRACT-UNBIND\"", "\"ABSTRACT-OPERATION\"",
            "\"ABSTRACT-ERROR\"", "\"ALGORITHM\"", "\"ENCRYPTED\"", "\"SIGNED\"", "\"SIGNATURE\"", "\"PROTECTED\"",
            "\"OBJECT-TYPE\"", "\"MACRO\"", "ISO646_STR_KW", "T61_STR_KW", "\"SYNTAX\"", "\"ACCESS\"", "\"STATUS\"",
            "\"DESCRIPTION\"", "\"REFERENCE\"", "\"INDEX\"", "\"DEFVAL\"", "ALL", "EXCEPT", "INCLUDES", "PATTERN_KW" };
